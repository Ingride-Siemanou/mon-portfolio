...
// Logos (tu peux changer si tu veux)
  ...
  return (
    <section className="certifications-section" id="certifications">
      ...
      <p className="cert-text">
        Je suis passionné par ma formation métier et je m'efforce constamment d'approfondir mes connaissances. Ces certifications sont le reflet de mon parcours d'apprentissage et de mon désir de me perfectionner.
      </p>
